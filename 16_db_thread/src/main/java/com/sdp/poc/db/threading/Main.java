package com.sdp.poc.db.threading;

import com.sdp.poc.threading.base.parameters.*;

import com.sdp.poc.db.threading.core.CtxDB;
import com.sdp.poc.db.threading.repository.UsuarioRepo;
...
public class Main extends MainBase implements ApplicationRunner {
    private CtxDB ctx = CtxDB.getInstance();;
