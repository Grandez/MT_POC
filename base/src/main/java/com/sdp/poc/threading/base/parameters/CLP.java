...
public class CLP {
    ...
    public static Props parseParms(String[] args, Map<String, CLP_Parameter> options)  {
        props = new Props();
        Map<String, CLP_Parameter> opt = addDefaults(options);
        try {
    ...
    private static int processParameter(int idx, String[] args, Map<String, CLP_Parameter> options) throws InvalidArgumentException {
    ...
    private static int processSwitch(int idx, String[] args, Map<String, CLP_Parameter> options) throws InvalidArgumentException {
    ...
    private static int parseParm(int idx, String[] args, CLP_Parameter parm, Properties props) throws InvalidArgumentException {
    ...
    private static Map<String, CLP_Parameter> addDefaults(Map<String, CLP_Parameter> options) {
        Map<String, CLP_Parameter> opt = new HashMap<String, CLP_Parameter>();
        opt.putAll(options);
        options.put("log",   new CLP_Parameter("log",   CLP_TYPE.NINT));
        options.put("debug", new CLP_Parameter("debug", CLP_TYPE.NINT));
        options.put("info",  new CLP_Parameter("info",  CLP_TYPE.NINT));
        return opt;
    }
}
